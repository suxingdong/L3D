...
namespace GF
{
    ...
    public class AudioManager : Singleton<AudioManager>
    {
        ...
        public bool Init()
        {
            ...
            GameObject cam = GameObject.Find("Canvas");
            //if (cam == null)
            ...
            //InitLogic.StartInit();
            Boot.Instance.StartInnerCoroutine(Initaudio(null));
            LoadAudioValue();
            SetBGMusicVolue(m_BgValue);
            SetMusicVolue(m_Value);
            //int bg = Random.Range(4, 7);
            int bg = 1;
            Instance.PlayerBGMusic(Audio.EffectBGType.EffectBGSound2);
