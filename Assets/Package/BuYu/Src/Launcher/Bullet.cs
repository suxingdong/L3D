...
namespace BuYu
{
    ...
    {
        private const float LOCK_FISH_RADIUS = 35.0f;
        private static float LIFE_TIME = 1.5f;
        private byte m_LauncherType;
        private byte m_ClientSeat;
        private byte m_RateIndex;
        private float m_Time;
        private byte m_ID;
        private byte m_ReboundCount;
        private float m_Angle;
        private Vector3 m_Pos;
        private Vector3 m_Dir;
        private GameObject m_Object;
        private Transform m_Trans;
        private GameObject m_BulletParEft;
        private Transform m_ParEftTrans;
        private int m_GoldNum = 0;
        private ushort m_LockFishID = 0;
        private Vector3 m_OrgDir;
        ...
        public void Init(byte clientSeat, byte id, byte launcherType, byte rateIndex, Vector3 startPos, Vector3 dir,
        ...
        public int GoldNum
        {
            get { return m_GoldNum; }
            set { m_GoldNum = value; }
        }

        public byte ClientSeat
        {
            get { return m_ClientSeat; }
        }
        ...
        {
            get { return m_LockFishID; }
        }

        private bool UpdateLockFish()
        {
