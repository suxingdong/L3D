...
namespace BuYu
{
    ...
    {
        private Object[] m_GunFireObj = new Object[ConstValue.MAX_LAUNCHER_NUM];
        private Object[] m_GaiEftObj = new Object[ConstValue.MAX_LAUNCHER_NUM];
        private Object[] m_MoveLightObj = new Object[ConstValue.MAX_LAUNCHER_NUM];
        private Object m_ChangeEftObj;
        private Object m_SkillActiveObj; //大招激活特效
        private Object m_SkillAvatarObj; //头像显示当前播放技能的特效
        private Object[] m_SkillLiveObj = new Object[ConstValue.MAX_LAUNCHER_NUM]; //大招畜力特效
        private Object[] m_SkillMuzzleObj = new Object[ConstValue.MAX_LAUNCHER_NUM]; //大招炮口特效
        private Object[] m_SkillLaserOjb = new Object[ConstValue.MAX_LAUNCHER_NUM]; //大招特效

        private GameObject m_SkillActiveEft = null;
        private GameObject m_SkillLiveEft = null;
        private GlobalEffectData m_XPSkillMuzzleEft = null;

        private GameObject[] m_MoveLightEft = new GameObject[ConstValue.PLAYER_MAX_NUM];
