...
namespace BuYu
{
    ...
    {
        private int m_EnergyMax; //能量值
        private int m_CurEnergy; //当前能量值
        private float m_RollbackInterval; //回滚频率
        private float m_RollbackTime;
        private float m_LaserCDTime; //大招CD
        private float m_CurCDTime;
        private float m_HitRecoverTime; //硬直时间
        private float m_CurHitRecover;
        private float m_FillAmount;
        private bool m_bFull;
        private bool m_bLaserCDState; //是否为CD状态  
        private bool m_bHitRecoverState; //是否为硬直状态
        private bool m_bRollback;
        private bool m_bSendXPSkill;
