...
namespace BuYu
{
    ...
    class BoxFly
    {
        ...
        public void Init(Vector3 vStart, Vector3 vEnd, Object objEff1)
        {
            ...
            m_goEffect1.transform.SetParent(SceneBoot.Instance.UIPanelTransform, false);
    ...
    class BoxShow
    {
        ...
        private void BuildObject(byte nIndex, Object obj, Transform tfpos)
        {
            ...
            m_goBox[nIndex].transform.SetParent(SceneBoot.Instance.UIPanelTransform, false);
    ...
    public class SceneChestMgr
    {
        ...
        public void ShowLabel(int nIndex)
        {
            ...
            m_BtnInfo[nIndex].m_sprBg.name = "ChestBoxNum";
        ...
        public void SetButton(bool bEnable)
        {
            for (byte i = 0; i < m_BtnInfo.Length; i++)
            {
                m_BtnInfo[i].m_BtnInfo.enabled = bEnable;
            }
            m_btnCancel.enabled = bEnable;
        ...
        void ShowReward(bool bImmediately, byte byIndex, byte byRewardid, byte byChestOnceID, bool bOpened)
        {
            ...
            m_BtnInfo[byIndex].m_sprBg.name = "ChestPropertyNum";

            m_BtnInfo[byIndex].m_goItem.SetActive(true);
            m_BtnInfo[byIndex].m_sprItem.name = pItemConfig.ItemIcon.ToString();
            if (!bImmediately)
            {
                if (bOpened)
                {
