...
namespace BuYu
{
    ...
    {
        private ScenePlayer[] m_PlayerList = new ScenePlayer[ConstValue.PLAYER_MAX_NUM];
        private Object[] m_LauncherObj = new Object[ConstValue.PLAYER_MAX_NUM];
        private Object[] m_GunBarrelObj = new Object[ConstValue.MAX_LAUNCHER_NUM*2];
        private Object m_ComboObj = null;
        private Object m_ComboEftObj = null;
        private Object m_LockedObj = null;

        private byte m_MyClientSeat; //自己的座位
        private ushort m_LockedFishID = 0; //锁定的鱼ID，0未锁定
        ...
        {
            get { return m_bAutoShot | (m_LockedFishID != 0); }
        }

        public bool AutoLocked
        {
            get { return m_bAutoLocked; }
        }

        public bool AutoShot
        {
            get { return m_bAutoShot; }
        }
        ...
        {
            get { return m_PlayerList[m_MyClientSeat]; }
        }
        ...
        {
            get { return m_LockedFishID; }
            set { m_LockedFishID = value; }
        }
