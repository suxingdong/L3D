...
namespace BuYu
{
    ...
    struct ComboContent
    {
        ...
        public Image m_Star;
        public Text[] m_label;
        public Image m_HitBg;
        public Image m_Energy;
        public Image m_ZiTi;     //连击提示字
    ...
    public class SceneComboEft : BaseWnd
    {
        ...
        void ExchangeBg(ushort comboCount)
        {
            ...
            if (m_IsMySelf)
            {
                m_Combo[0].m_Star.name = "DoubleHit_Star_" + comboCount.ToString();
                m_Combo[0].m_Energy.name = "DoubleHit_energy_" + comboCount.ToString();
                m_Combo[0].m_HitBg.name = "DoubleHit_bg_" + comboCount.ToString();
                m_Combo[0].m_ZiTi.name = "DoubleHit_ZT_" + comboCount.ToString();
            }
            else
                m_Combo[0].m_ZiTi.name = "DoubleHit_ZT_" + comboCount.ToString();
