...
namespace BuYu
{
    ...
    public class ServerSetting
    {
        ...
        public static bool Init()
        {
            ...
            //InitLogic.StartInit();
           // SceneBoot.Instance.StartInnerCoroutine(OnNewInit(null));
        ...
        public static System.Collections.IEnumerator OnNewInit(object objd)
        {
            Object obj = ResManager.Instance.LoadObject("ServerSetting", "BuYu/GlobalRes/ServerSetting/", ResType.GlobalRes, typeof(TextAsset));
            if (obj == null)
            {
