...
namespace Lobby
{
    class RoleInfo
    {
        ...
        public bool ChangeRoleShareSatate(bool States)
        {
            ...
            NetManager.Instance.Send<CL_Cmd_ChangeRoleShareStates>(ncb);
            //LogMgr.Log("已经分享");
            return true;
        }
        public bool ChangeRoleRateValue(Byte AddRateIndex)
        {
            ...
            NetManager.Instance.Send<CL_Cmd_ChangeRoleRateValue>(ncb);
            return true;
        }
        ...
        public void ResetSceneInfo()
        {
            ...
            NetManager.Instance.Send<CL_Cmd_ResetRoleInfo>(ncb);
        }
